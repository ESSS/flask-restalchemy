...
from flask_rest_orm.tests.sample_model import Employee, Company, EmployeeSerializer
...
def sample_api(flask_app):
    ...
    api.add_relation(Employee, 'company_id', Company, serializer=EmployeeSerializer())
    return api
